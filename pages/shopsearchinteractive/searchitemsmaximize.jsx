...
const SearchItemsMaximize = (props) => {
    ...
    console.log("VIEW ViewCheckout : ",  viewSearch)
    ...
    const [dataRangePre, setDataRangePre] = useState([]);
    ...
    if (dataPrdItem && dataPrdItem.length > 0) {
        ...
        // console.log("ALLPRD XXXX: ", dataPrdItem);
        ...
        if (conditionselect === 0 && !activafiltrociudad && !changesearchprice) {
            allprd2 = dataPrdItem;
            dataPrdItem &&
                dataPrdItem.map((item) => {
                    if (item.productogenerico == "No") {
