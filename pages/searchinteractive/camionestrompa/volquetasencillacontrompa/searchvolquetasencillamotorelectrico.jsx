...
const SearchInteractiveMotorElectrico = (props) => {
    ...
    useEffect(() => {
        ...
        if (datosFaltantes) {
            if (habilitaCajaMotor) {
                prdCajaMotorVolquetaSencilla();
            }
            if (habilitaEnframientoMotor) {
                prdEnframientoMotorVolquetaSencilla();
            }
            if (habilitaEmbrague) {
                prdEmbragueVolquetaSencilla();
            }
            if (habilitaMotor) {
                prdMotorVolquetaSencilla();
            }
            if (habilitaInyeccion) {
                prdInyeccionVolquetaSencilla();
            }
            if (habilitaRefrijeracion) {
                prdRefrijeracionVolquetaSencilla();
            }
            if (habilitaTrasmision) {
                prdTrasmisionVolquetaSencilla();
            }
    ...
    const mostrarAireAcondicionadoVolquetaSencilla = () => {
    ...
    const cerrarAireAcondicionadoVolquetaSencilla = () => {
        setShowAirecondicionado(false);
        setShowImagenMtrElect(true);
    };

    const mostrarDireccionVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarDireccionVolquetaSencilla = () => {
        setShowDireccion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarFrenosVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
            setShowFrenos(true);
            setOnClickImagenMtrElect(false);
    ...
    const cerrarFrenosVolquetaSencilla = () => {
        setShowFrenos(false);
        setShowImagenMtrElect(true);
    };

    const mostrarMotorcajaVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
            setShowCaja(true);
            setOnClickImagenMtrElect(false);
    ...
    const cerrarMotorcajaVolquetaSencilla = () => {
        setShowCaja(false);
        setShowImagenMtrElect(true);
    };

    const mostrarRefrigeracioncajaVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarRefrigeracioncajaVolquetaSencilla = () => {
        setShowRefrigeracioncaja(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdearranqueVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdearranqueVolquetaSencilla = () => {
        setShowImagenMtrElect(true);
        setShowSistdearranque(false);
    };

    const mostrarSistparabrisasVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistparabrisasVolquetaSencilla = () => {
        setShowImagenMtrElect(true);
        setShowSistparabrisas(false);
    };

    const mostrarSistmotorVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
    ...
    const cerrarSistmotorVolquetaSencilla = () => {
        setShowSistmotor(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeEmbragueVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeEmbragueVolquetaSencilla = () => {
        setShowSistdeEmbrague(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeEscapeVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeEscapeVolquetaSencilla = () => {
        setShowSistdeEscape(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeInyeccionVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeInyeccionVolquetaSencilla = () => {
        setShowSistdeInyeccion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeRefrigeracionVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeRefrigeracionVolquetaSencilla = () => {
        setShowSistdeRefrigeracion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeElectricoVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeElectricoVolquetaSencilla = () => {
        setShowSistdeElectrico(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeElectricoMotorVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeElectricoMotorVolquetaSencilla = () => {
        setShowSistdeElectricoMotor(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSuspensionVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSuspensionVolquetaSencilla = () => {
        setShowSuspension(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistTrasmisionVolquetaSencilla = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistTrasmisionVolquetaSencilla = () => {
        setShowSistTrasmision(false);
        setShowImagenMtrElect(true);
    };

    const prdAireacondicionadoVolquetaSencilla = () => {
    ...
    const prdDireccionVolquetaSencilla = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdFrenosVolquetaSencilla = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdCajaMotorVolquetaSencilla = () => {
        setDatosFaltantes(false);
        let tipotraccion = datosbuscadorinteractivo.nombretraccion;
    ...
    const prdEnframientoMotorVolquetaSencilla = () => {
        setDatosFaltantes(false);
        let tipotraccion = datosbuscadorinteractivo.nombretraccion;
        let tipotransmision = datosbuscadorinteractivo.nombretransmision;
    ...
    const prdArranqueVolquetaSencilla = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdParabrisasVolquetaSencilla = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdMotorVolquetaSencilla = () => {
    ...
    const prdEmbragueVolquetaSencilla = () => {
        setDatosFaltantes(false);
        if (
    ...
    const prdEscapeVolquetaSencilla = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdInyeccionVolquetaSencilla = () => {
        setDatosFaltantes(false);
        let tipocombustible = datosbuscadorinteractivo.nombretipocombustible;
    ...
    const prdRefrijeracionVolquetaSencilla = () => {
        setDatosFaltantes(false);
        let tipocombustible = datosbuscadorinteractivo.nombretipocombustible;
    ...
    const prdElectricoVehiculoVolquetaSencilla = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdElectricoMotorVolquetaSencilla = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdSuspensionVolquetaSencilla = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdTrasmisionVolquetaSencilla = () => {
        setDatosFaltantes(false);
        let tipotraccion = datosbuscadorinteractivo.nombretraccion;
        let tipotransmision = datosbuscadorinteractivo.nombretransmision;
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    ...
                                                                    onMouseOver={
                                                                        mostrarSistdeInyeccionVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeInyeccionVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdInyeccionVolquetaSencilla()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeRefrigeracionVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeRefrigeracionVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdRefrijeracionVolquetaSencilla()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeElectricoMotorVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeElectricoMotorVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdElectricoMotorVolquetaSencilla()
                                                                    }
                                                                    src={
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdearranqueVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdearranqueVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdArranqueVolquetaSencilla()
                                                                    }
                                                                    src={
                                                                        showarranque.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeEscapeVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeEscapeVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdEscapeVolquetaSencilla()
                                                                    }
                                                                    src={
                                                                        showescape.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarAireAcondicionadoVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarAireAcondicionadoVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdAireacondicionadoVolquetaSencilla()
                                                                    }
                                                                    src={
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistmotorVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistmotorVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdMotorVolquetaSencilla()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeEmbragueVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeEmbragueVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdEmbragueVolquetaSencilla()
                                                                    }
                                            ...
                                            <div className="col-md-1 posiciontres ml-520">
                                                <Col xs lg={1}>
                                                    <Row xs={2} md={4} lg={12}>
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico deshabilitardiv">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarRefrigeracioncajaVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarRefrigeracioncajaVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdEnframientoMotorVolquetaSencilla()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div 
                                                                className="bordediviconomotorelectrico deshabilitardiv">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarMotorcajaVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarMotorcajaVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdCajaMotorVolquetaSencilla()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico deshabilitardiv">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistTrasmisionVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistTrasmisionVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdTrasmisionVolquetaSencilla()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarDireccionVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarDireccionVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdDireccionVolquetaSencilla()
                                                                    }
                                                                    src={
                                                                        showdireccion.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarFrenosVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarFrenosVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdFrenosVolquetaSencilla()
                                                                    }
                                                                    src={
                                                                        showfrenos.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSuspensionVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSuspensionVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdSuspensionVolquetaSencilla()
                                                                    }
                                                                    src={
                                                                        showsuspension.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistparabrisasVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistparabrisasVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdParabrisasVolquetaSencilla()
                                                                    }
                                                                    src={
                                                                        showparabrisas.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeElectricoVolquetaSencilla
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeElectricoVolquetaSencilla
                                                                    }
                                                                    onClick={() =>
                                                                        prdElectricoVehiculoVolquetaSencilla()
                                                                    }
                                                                    src={
                ...
                <Col xs lg={10}>
                    {!onClickImagenMtrElect ? (
                        showImagenMtrElect ? (
                            <Row>
                                <Col xs lg={12}>
                                    <div className="cajaimagenesmotorelectricovolquetasencilla pt-9">
                                        <h2 className="mt-49 seccionesvehiculotexto"></h2>
                                        <img src={imagenBase.src} />
                                    </div>
                                </Col>
                            </Row>
                        ) : showSistmotor ? (
                            <div className="cajaimagenesmotorelectricovolquetasencilla">
                            ...
                            <div className="cajaimagenesmotorelectricovolquetasencilla espaciosuperior">
