...
const SearchInteractiveMotorElectrico = (props) => {
    ...
    useEffect(() => {
        ...
        if (datosFaltantes) {
            if (habilitaCajaMotor) {
                prdCajaMotorCuatroManos();
            }
            if (habilitaEnframientoMotor) {
                prdEnframientoMotorCuatroManos();
            }
            if (habilitaEmbrague) {
                prdEmbragueCuatroManos();
            }
            if (habilitaMotor) {
                prdMotorCuatroManos();
            }
            if (habilitaInyeccion) {
                prdInyeccionCuatroManos();
            }
            if (habilitaRefrijeracion) {
                prdRefrijeracionCuatroManos();
            }
            if (habilitaTrasmision) {
                prdTrasmisionCuatroManos();
            }
    ...
    const mostrarAireAcondicionadoCuatroManos = () => {
    ...
    const cerrarAireAcondicionadoCuatroManos = () => {
        setShowAirecondicionado(false);
        setShowImagenMtrElect(true);
    };

    const mostrarDireccionCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarDireccionCuatroManos = () => {
        setShowDireccion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarFrenosCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
            setShowFrenos(true);
            setOnClickImagenMtrElect(false);
    ...
    const cerrarFrenosCuatroManos = () => {
        setShowFrenos(false);
        setShowImagenMtrElect(true);
    };

    const mostrarMotorcajaCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
            setShowCaja(true);
            setOnClickImagenMtrElect(false);
    ...
    const cerrarMotorcajaCuatroManos = () => {
        setShowCaja(false);
        setShowImagenMtrElect(true);
    };

    const mostrarRefrigeracioncajaCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarRefrigeracioncajaCuatroManos = () => {
        setShowRefrigeracioncaja(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdearranqueCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdearranqueCuatroManos = () => {
        setShowImagenMtrElect(true);
        setShowSistdearranque(false);
    };

    const mostrarSistparabrisasCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistparabrisasCuatroManos = () => {
        setShowImagenMtrElect(true);
        setShowSistparabrisas(false);
    };

    const mostrarSistmotorCuatroManos = () => {
        if (!onClickImagenMtrElect) {
    ...
    const cerrarSistmotorCuatroManos = () => {
        setShowSistmotor(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeEmbragueCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeEmbragueCuatroManos = () => {
        setShowSistdeEmbrague(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeEscapeCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeEscapeCuatroManos = () => {
        setShowSistdeEscape(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeInyeccionCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeInyeccionCuatroManos = () => {
        setShowSistdeInyeccion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeRefrigeracionCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeRefrigeracionCuatroManos = () => {
        setShowSistdeRefrigeracion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeElectricoCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeElectricoCuatroManos = () => {
        setShowSistdeElectrico(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeElectricoMotorCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeElectricoMotorCuatroManos = () => {
        setShowSistdeElectricoMotor(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSuspensionCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSuspensionCuatroManos = () => {
        setShowSuspension(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistTrasmisionCuatroManos = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistTrasmisionCuatroManos = () => {
        setShowSistTrasmision(false);
        setShowImagenMtrElect(true);
    };

    const prdAireacondicionadoCuatroManos = () => {
    ...
    const prdEnframientoMotorCuatroManos = () => {
        setDatosFaltantes(false);
        let tipotraccion = datosbuscadorinteractivo.nombretraccion;
        let tipotransmision = datosbuscadorinteractivo.nombretransmision;
    ...
    const prdParabrisasCuatroManos = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdRefrijeracionCuatroManos = () => {
        setDatosFaltantes(false);
        let tipocombustible = datosbuscadorinteractivo.nombretipocombustible;
    ...
    const prdElectricoVehiculoCuatroManos = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdElectricoMotorCuatroManos = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdSuspensionCuatroManos = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdTrasmisionCuatroManos = () => {
        setDatosFaltantes(false);
        let tipotraccion = datosbuscadorinteractivo.nombretraccion;
        let tipotransmision = datosbuscadorinteractivo.nombretransmision;
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    ...
                                                                    onMouseOver={
                                                                        mostrarSistdeInyeccionCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeInyeccionCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdInyeccionCuatroManos()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeRefrigeracionCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeRefrigeracionCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdRefrijeracionCuatroManos()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeElectricoMotorCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeElectricoMotorCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdElectricoMotorCuatroManos()
                                                                    }
                                                                    src={
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdearranqueCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdearranqueCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdArranqueCuatroManos()
                                                                    }
                                                                    src={
                                                                        showarranque.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeEscapeCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeEscapeCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdEscapeCuatroManos()
                                                                    }
                                                                    src={
                                                                        showescape.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarAireAcondicionadoCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarAireAcondicionadoCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdAireacondicionadoCuatroManos()
                                                                    }
                                                                    src={
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistmotorCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistmotorCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdMotorCuatroManos()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeEmbragueCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeEmbragueCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdEmbragueCuatroManos()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico deshabilitardiv">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarRefrigeracioncajaCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarRefrigeracioncajaCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdEnframientoMotorCuatroManos()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div 
                                                                ...
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarMotorcajaCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarMotorcajaCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdCajaMotorCuatroManos()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico deshabilitardiv">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistTrasmisionCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistTrasmisionCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdTrasmisionCuatroManos()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarDireccionCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarDireccionCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdDireccionCuatroManos()
                                                                    }
                                                                    src={
                                                                        showdireccion.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarFrenosCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarFrenosCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdFrenosCuatroManos()
                                                                    }
                                                                    src={
                                                                        showfrenos.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSuspensionCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSuspensionCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdSuspensionCuatroManos()
                                                                    }
                                                                    src={
                                                                        showsuspension.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistparabrisasCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistparabrisasCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdParabrisasCuatroManos()
                                                                    }
                                                                    src={
                                                                        showparabrisas.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeElectricoCuatroManos
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeElectricoCuatroManos
                                                                    }
                                                                    onClick={() =>
                                                                        prdElectricoVehiculoCuatroManos()
                                                                    }
                                                                    src={
