...
const SearchInteractiveMotorElectrico = (props) => {
    ...
    useEffect(() => {
        ...
        if (datosFaltantes) {
            if (habilitaCajaMotor) {
                prdCajaMotorVolquetaDoble();
            }
            if (habilitaEnframientoMotor) {
                prdEnframientoMotorVolquetaDoble();
            }
            if (habilitaEmbrague) {
                prdEmbragueVolquetaDoble();
            }
            if (habilitaMotor) {
                prdMotorVolquetaDoble();
            }
            if (habilitaInyeccion) {
                prdInyeccionVolquetaDoble();
            }
            if (habilitaRefrijeracion) {
                prdRefrijeracionVolquetaDoble();
            }
            if (habilitaTrasmision) {
                prdTrasmisionVolquetaDoble();
            }
    ...
    const mostrarAireAcondicionadoVolquetaDoble = () => {
    ...
    const cerrarAireAcondicionadoVolquetaDoble = () => {
        setShowAirecondicionado(false);
        setShowImagenMtrElect(true);
    };

    const mostrarDireccionVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarDireccionVolquetaDoble = () => {
        setShowDireccion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarFrenosVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
            setShowFrenos(true);
            setOnClickImagenMtrElect(false);
    ...
    const cerrarFrenosVolquetaDoble = () => {
        setShowFrenos(false);
        setShowImagenMtrElect(true);
    };

    const mostrarMotorcajaVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
            setShowCaja(true);
            setOnClickImagenMtrElect(false);
    ...
    const cerrarMotorcajaVolquetaDoble = () => {
        setShowCaja(false);
        setShowImagenMtrElect(true);
    };

    const mostrarRefrigeracioncajaVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarRefrigeracioncajaVolquetaDoble = () => {
        setShowRefrigeracioncaja(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdearranqueVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdearranqueVolquetaDoble = () => {
        setShowImagenMtrElect(true);
        setShowSistdearranque(false);
    };

    const mostrarSistparabrisasVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistparabrisasVolquetaDoble = () => {
        setShowImagenMtrElect(true);
        setShowSistparabrisas(false);
    };

    const mostrarSistmotorVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
    ...
    const cerrarSistmotorVolquetaDoble = () => {
        setShowSistmotor(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeEmbragueVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeEmbragueVolquetaDoble = () => {
        setShowSistdeEmbrague(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeEscapeVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeEscapeVolquetaDoble = () => {
        setShowSistdeEscape(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeInyeccionVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeInyeccionVolquetaDoble = () => {
        setShowSistdeInyeccion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeRefrigeracionVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeRefrigeracionVolquetaDoble = () => {
        setShowSistdeRefrigeracion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeElectricoVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeElectricoVolquetaDoble = () => {
        setShowSistdeElectrico(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeElectricoMotorVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeElectricoMotorVolquetaDoble = () => {
        setShowSistdeElectricoMotor(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSuspensionVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSuspensionVolquetaDoble = () => {
        setShowSuspension(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistTrasmisionVolquetaDoble = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistTrasmisionVolquetaDoble = () => {
        setShowSistTrasmision(false);
        setShowImagenMtrElect(true);
    };

    const prdAireacondicionadoVolquetaDoble = () => {
    ...
    const prdDireccionVolquetaDoble = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdCajaMotorVolquetaDoble = () => {
        setDatosFaltantes(false);
        let tipotraccion = datosbuscadorinteractivo.nombretraccion;
    ...
    const prdEnframientoMotorVolquetaDoble = () => {
        setDatosFaltantes(false);
        let tipotraccion = datosbuscadorinteractivo.nombretraccion;
        let tipotransmision = datosbuscadorinteractivo.nombretransmision;
    ...
    const prdArranqueVolquetaDoble = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdParabrisasVolquetaDoble = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdEmbragueVolquetaDoble = () => {
        setDatosFaltantes(false);
        if (
    ...
    const prdInyeccionVolquetaDoble = () => {
        setDatosFaltantes(false);
        let tipocombustible = datosbuscadorinteractivo.nombretipocombustible;
    ...
    const prdRefrijeracionVolquetaDoble = () => {
        setDatosFaltantes(false);
        let tipocombustible = datosbuscadorinteractivo.nombretipocombustible;
    ...
    const prdElectricoVehiculoVolquetaDoble = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdElectricoMotorVolquetaDoble = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdSuspensionVolquetaDoble = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdTrasmisionVolquetaDoble = () => {
        setDatosFaltantes(false);
        let tipotraccion = datosbuscadorinteractivo.nombretraccion;
        let tipotransmision = datosbuscadorinteractivo.nombretransmision;
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    ...
                                                                    onMouseOver={
                                                                        mostrarSistdeInyeccionVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeInyeccionVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdInyeccionVolquetaDoble()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeRefrigeracionVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeRefrigeracionVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdRefrijeracionVolquetaDoble()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeElectricoMotorVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeElectricoMotorVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdElectricoMotorVolquetaDoble()
                                                                    }
                                                                    src={
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdearranqueVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdearranqueVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdArranqueVolquetaDoble()
                                                                    }
                                                                    src={
                                                                        showarranque.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeEscapeVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeEscapeVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdEscapeVolquetaDoble()
                                                                    }
                                                                    src={
                                                                        showescape.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarAireAcondicionadoVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarAireAcondicionadoVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdAireacondicionadoVolquetaDoble()
                                                                    }
                                                                    src={
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistmotorVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistmotorVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdMotorVolquetaDoble()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeEmbragueVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeEmbragueVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdEmbragueVolquetaDoble()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico deshabilitardiv">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarRefrigeracioncajaVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarRefrigeracioncajaVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdEnframientoMotorVolquetaDoble()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div 
                                                                ...
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarMotorcajaVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarMotorcajaVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdCajaMotorVolquetaDoble()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico deshabilitardiv">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistTrasmisionVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistTrasmisionVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdTrasmisionVolquetaDoble()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarDireccionVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarDireccionVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdDireccionVolquetaDoble()
                                                                    }
                                                                    src={
                                                                        showdireccion.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarFrenosVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarFrenosVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdFrenosVolquetaDoble()
                                                                    }
                                                                    src={
                                                                        showfrenos.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSuspensionVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSuspensionVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdSuspensionVolquetaDoble()
                                                                    }
                                                                    src={
                                                                        showsuspension.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistparabrisasVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistparabrisasVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdParabrisasVolquetaDoble()
                                                                    }
                                                                    src={
                                                                        showparabrisas.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeElectricoVolquetaDoble
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeElectricoVolquetaDoble
                                                                    }
                                                                    onClick={() =>
                                                                        prdElectricoVehiculoVolquetaDoble()
                                                                    }
                                                                    src={
                ...
                <Col xs lg={10}>
                    {!onClickImagenMtrElect ? (
                        showImagenMtrElect ? (
                            <Row>
                                <Col xs lg={12}>
                                    <div className="cajaimagenesmotorelectricocamioncuatromanos pt-9">
                                        <h2 className="mt-55 seccionesvehiculotexto"></h2>
                                        <img src={imagenBase.src} />
                                    </div>
                                </Col>
                            </Row>
                        ) : showSistmotor ? (
                            <div className="cajaimagenesmotorelectricocamioncuatromanos">
                            ...
                            <div className="cajaimagenesmotorelectricocamioncuatromanos espaciosuperior">
