...
const SearchInteractiveMotorElectrico = (props) => {
    ...
    useEffect(() => {
        ...
        if (datosFaltantes) {
            if (habilitaCajaMotor) {
                prdCajaMotorSencillo();
            }
            if (habilitaEnframientoMotor) {
                prdEnframientoMotorSencillo();
            }
            if (habilitaEmbrague) {
                prdEmbragueSencillo();
            }
            ...
            if (habilitaInyeccion) {
                prdInyeccionSencillo();
            }
            if (habilitaRefrijeracion) {
                prdRefrijeracionSencillo();
            }
            if (habilitaTrasmision) {
                prdTrasmisionSencillo();
            }
    ...
    const mostrarAireAcondicionadoSencillo = () => {
    ...
    const cerrarAireAcondicionadoSencillo = () => {
        setShowAirecondicionado(false);
        setShowImagenMtrElect(true);
    };

    const mostrarDireccionSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarDireccionSencillo = () => {
        setShowDireccion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarFrenosSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
            setShowFrenos(true);
            setOnClickImagenMtrElect(false);
    ...
    const cerrarFrenosSencillo = () => {
        setShowFrenos(false);
        setShowImagenMtrElect(true);
    };

    const mostrarMotorcajaSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
            setShowCaja(true);
            setOnClickImagenMtrElect(false);
    ...
    const cerrarMotorcajaSencillo = () => {
        setShowCaja(false);
        setShowImagenMtrElect(true);
    };

    const mostrarRefrigeracioncajaSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarRefrigeracioncajaSencillo = () => {
        setShowRefrigeracioncaja(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdearranqueSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdearranqueSencillo = () => {
        setShowImagenMtrElect(true);
        setShowSistdearranque(false);
    };

    const mostrarSistparabrisasSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistparabrisasSencillo = () => {
        setShowImagenMtrElect(true);
        setShowSistparabrisas(false);
    };

    const mostrarSistmotorSencillo = () => {
        if (!onClickImagenMtrElect) {
    ...
    const cerrarSistmotorSencillo = () => {
        setShowSistmotor(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeEmbragueSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeEmbragueSencillo = () => {
        setShowSistdeEmbrague(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeEscapeSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeEscapeSencillo = () => {
        setShowSistdeEscape(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeInyeccionSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeInyeccionSencillo = () => {
        setShowSistdeInyeccion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeRefrigeracionSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeRefrigeracionSencillo = () => {
        setShowSistdeRefrigeracion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeElectricoSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeElectricoSencillo = () => {
        setShowSistdeElectrico(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeElectricoMotorSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeElectricoMotorSencillo = () => {
        setShowSistdeElectricoMotor(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSuspensionSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSuspensionSencillo = () => {
        setShowSuspension(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistTrasmisionSencillo = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistTrasmisionSencillo = () => {
        setShowSistTrasmision(false);
        setShowImagenMtrElect(true);
    };

    const prdAireacondicionadoSencillo = () => {
    ...
    const prdEnframientoMotorSencillo = () => {
        setDatosFaltantes(false);
        let tipotraccion = datosbuscadorinteractivo.nombretraccion;
        let tipotransmision = datosbuscadorinteractivo.nombretransmision;
    ...
    const prdRefrijeracionSencillo = () => {
        setDatosFaltantes(false);
        let tipocombustible = datosbuscadorinteractivo.nombretipocombustible;
    ...
    const prdElectricoVehiculoSencillo = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdElectricoMotorSencillo = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    ...
                                                                    onMouseOver={
                                                                        mostrarSistdeInyeccionSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeInyeccionSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdInyeccionSencillo()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeRefrigeracionSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeRefrigeracionSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdRefrijeracionSencillo()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeElectricoMotorSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeElectricoMotorSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdElectricoMotorSencillo()
                                                                    }
                                                                    src={
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdearranqueSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdearranqueSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdArranqueSencillo()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeEscapeSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeEscapeSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdEscapeSencillo()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarAireAcondicionadoSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarAireAcondicionadoSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdAireacondicionadoSencillo()
                                                                    }
                                                                    src={
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistmotorSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistmotorSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdMotorSencillo()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeEmbragueSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeEmbragueSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdEmbragueSencillo()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico deshabilitardiv">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarRefrigeracioncajaSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarRefrigeracioncajaSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdEnframientoMotorSencillo()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div 
                                                                ...
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarMotorcajaSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarMotorcajaSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdCajaMotorSencillo()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico deshabilitardiv">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistTrasmisionSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistTrasmisionSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdTrasmisionSencillo()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarDireccionSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarDireccionSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdDireccionSencillo()
                                                                    }
                                                                    src={
                                                                        showdireccion.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarFrenosSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarFrenosSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdFrenosSencillo()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSuspensionSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSuspensionSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdSuspensionSencillo()
                                                                    }
                                                                    src={
                                                                        showsuspension.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistparabrisasSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistparabrisasSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdParabrisasSencillo()
                                                                    }
                                                                    src={
                                                                        showparabrisas.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeElectricoSencillo
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeElectricoSencillo
                                                                    }
                                                                    onClick={() =>
                                                                        prdElectricoVehiculoSencillo()
                                                                    }
                                                                    src={
                ...
                <Col xs lg={10}>
                    {!onClickImagenMtrElect ? (
                        showImagenMtrElect ? (
                            <Row>
                                <Col xs lg={12}>
                                    <div className="cajaimagenesmotorelectricocamionsintrompasencillo pt-29">
                            ...
                            <div className="cajaimagenesmotorelectricocamionsintrompasencillo">
                            ...
                            <div className="cajaimagenesmotorelectricocamionsintrompasencillo espaciosuperior">
