...
const SearchInteractiveMotorElectrico = (props) => {
    ...
    useEffect(() => {
        ...
        if (datosFaltantes) {
            if (habilitaCajaMotor) {
                prdCajaMotorDobleTroque();
            }
            if (habilitaEnframientoMotor) {
                prdEnframientoMotorDobleTroque();
            }
            if (habilitaEmbrague) {
                prdEmbragueDobleTroque();
            }
            if (habilitaMotor) {
                prdMotorDobleTroque();
            }
            if (habilitaInyeccion) {
                prdInyeccionDobleTroque();
            }
            if (habilitaRefrijeracion) {
                prdRefrijeracionDobleTroque();
            }
            if (habilitaTrasmision) {
                prdTrasmisionDobleTroque();
            }
    ...
    const mostrarAireAcondicionadoDobleTroque = () => {
    ...
    const cerrarAireAcondicionadoDobleTroque = () => {
        setShowAirecondicionado(false);
        setShowImagenMtrElect(true);
    };

    const mostrarDireccionDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarDireccionDobleTroque = () => {
        setShowDireccion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarFrenosDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
            setShowFrenos(true);
            setOnClickImagenMtrElect(false);
    ...
    const cerrarFrenosDobleTroque = () => {
        setShowFrenos(false);
        setShowImagenMtrElect(true);
    };

    const mostrarMotorcajaDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
            setShowCaja(true);
            setOnClickImagenMtrElect(false);
    ...
    const cerrarMotorcajaDobleTroque = () => {
        setShowCaja(false);
        setShowImagenMtrElect(true);
    };

    const mostrarRefrigeracioncajaDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarRefrigeracioncajaDobleTroque = () => {
        setShowRefrigeracioncaja(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdearranqueDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdearranqueDobleTroque = () => {
        setShowImagenMtrElect(true);
        setShowSistdearranque(false);
    };

    const mostrarSistparabrisasDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistparabrisasDobleTroque = () => {
        setShowImagenMtrElect(true);
        setShowSistparabrisas(false);
    };

    const mostrarSistmotorDobleTroque = () => {
        if (!onClickImagenMtrElect) {
    ...
    const cerrarSistmotorDobleTroque = () => {
        setShowSistmotor(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeEmbragueDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeEmbragueDobleTroque = () => {
        setShowSistdeEmbrague(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeEscapeDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeEscapeDobleTroque = () => {
        setShowSistdeEscape(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeInyeccionDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeInyeccionDobleTroque = () => {
        setShowSistdeInyeccion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeRefrigeracionDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeRefrigeracionDobleTroque = () => {
        setShowSistdeRefrigeracion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeElectricoDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeElectricoDobleTroque = () => {
        setShowSistdeElectrico(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeElectricoMotorDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeElectricoMotorDobleTroque = () => {
        setShowSistdeElectricoMotor(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSuspensionDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSuspensionDobleTroque = () => {
        setShowSuspension(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistTrasmisionDobleTroque = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistTrasmisionDobleTroque = () => {
        setShowSistTrasmision(false);
        setShowImagenMtrElect(true);
    };

    const prdAireacondicionadoDobleTroque = () => {
    ...
    const prdEnframientoMotorDobleTroque = () => {
        setDatosFaltantes(false);
        let tipotraccion = datosbuscadorinteractivo.nombretraccion;
        let tipotransmision = datosbuscadorinteractivo.nombretransmision;
    ...
    const prdParabrisasDobleTroque = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdRefrijeracionDobleTroque = () => {
        setDatosFaltantes(false);
        let tipocombustible = datosbuscadorinteractivo.nombretipocombustible;
    ...
    const prdElectricoVehiculoDobleTroque = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdElectricoMotorDobleTroque = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdSuspensionDobleTroque = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
    ...
    const prdTrasmisionDobleTroque = () => {
        setDatosFaltantes(false);
        let tipotraccion = datosbuscadorinteractivo.nombretraccion;
        let tipotransmision = datosbuscadorinteractivo.nombretransmision;
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    ...
                                                                    onMouseOver={
                                                                        mostrarSistdeInyeccionDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeInyeccionDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdInyeccionDobleTroque()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeRefrigeracionDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeRefrigeracionDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdRefrijeracionDobleTroque()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeElectricoMotorDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeElectricoMotorDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdElectricoMotorDobleTroque()
                                                                    }
                                                                    src={
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdearranqueDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdearranqueDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdArranqueDobleTroque()
                                                                    }
                                                                    src={
                                                                        showarranque.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeEscapeDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeEscapeDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdEscapeDobleTroque()
                                                                    }
                                                                    src={
                                                                        showescape.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarAireAcondicionadoDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarAireAcondicionadoDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdAireacondicionadoDobleTroque()
                                                                    }
                                                                    src={
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistmotorDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistmotorDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdMotorDobleTroque()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeEmbragueDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeEmbragueDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdEmbragueDobleTroque()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico deshabilitardiv">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarRefrigeracioncajaDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarRefrigeracioncajaDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdEnframientoMotorDobleTroque()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div 
                                                                ...
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarMotorcajaDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarMotorcajaDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdCajaMotorDobleTroque()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico deshabilitardiv">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistTrasmisionDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistTrasmisionDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdTrasmisionDobleTroque()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarDireccionDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarDireccionDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdDireccionDobleTroque()
                                                                    }
                                                                    src={
                                                                        showdireccion.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarFrenosDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarFrenosDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdFrenosDobleTroque()
                                                                    }
                                                                    src={
                                                                        showfrenos.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSuspensionDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSuspensionDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdSuspensionDobleTroque()
                                                                    }
                                                                    src={
                                                                        showsuspension.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistparabrisasDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistparabrisasDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdParabrisasDobleTroque()
                                                                    }
                                                                    src={
                                                                        showparabrisas.src
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeElectricoDobleTroque
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeElectricoDobleTroque
                                                                    }
                                                                    onClick={() =>
                                                                        prdElectricoVehiculoDobleTroque()
                                                                    }
                                                                    src={
