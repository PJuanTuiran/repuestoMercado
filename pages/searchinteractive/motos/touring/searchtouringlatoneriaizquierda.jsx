...
const TouringLatoneriaLatoneriaIzquierda = (props) => {
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        router.push("/searchinteractive/motos/touring/searchtouringmotorelectrico");
    };
    ...
    const irLatoneriaCentro = () => {
        router.push("/searchinteractive/motos/touring/searchtouringlatoneriacentro");
    };

    const irLatoneriaDerecha = () => {
        router.push("/searchinteractive/motos/touring/searchtouringlatoneriaderecha");
    };
