...
const CalleLatoneriaLatoneriaIzquierda = (props) => {
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        router.push("/searchinteractive/motos/motocarro/searchcallemotorelectrico");
    };
    ...
    const irLatoneriaCentro = () => {
        router.push("/searchinteractive/motos/motocarro/searchcallelatoneriacentro");
    };

    const irLatoneriaDerecha = () => {
        router.push("/searchinteractive/motos/motocarro/searchcallelatoneriaderecha");
    };
