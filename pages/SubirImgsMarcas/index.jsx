...
import { URL_IMAGES_RESULTSSMS, URL_IMAGES_MARCAS } from "../../helpers/Constants";
    ...
    useEffect(() => {
        const obtenerImagenes = async () => {
            try {
                ...
                setImagenes(res.data.listimgmarcas);
            } catch (error) {
                            ...
                            <div className="ps-page__content ps-account" style={{ marginBottom: "18rem" }}>
                                <Grid
                                    ...
                                    <div className="TitleOpVend">
                                        ...
                                        <p>*Recomendación, subir imagenes de 600px por alto y 400px ancho para que se vea bien</p>
                                    </div>
                                    ...
                                    <div className="SubirImagenesCarruselBanner">
                                        {Imagenes && Imagenes.sort((a, b) => a.id - b.id).map((imagen, index) => (
                                            <div key={index} className="SubirImagenesCarruselBannerDiv">
                                                <p>Imagen {Imagenes[index].nombremarca}</p>
                                                <img src={previewImages[imagen.id] || `${URL_IMAGES_MARCAS}${imagen.nombreimagen}`} alt={`Imagen ${index + 1}`} />
