...
import { Tooltip, TableRow, Paper, IconButton, rowsPerPage } from "@mui/material";
            ...
            const leerNotificacionesActivas = async () => {
                ...
                const leerData = async () => {
                    ...
                    await axios({
                        ...
                        .then((res) => {
                            if (res.data.type === 1) {
                                console.log("NOTIFI ACTIVAS:", res.data.listarnotificaciones);
                                ...
                                if (datanotificacion.length > 0) datanotificacion.sort(compare);
                ...
                <div>
                    <Container title="Mi Cuenta">
                        <div className="ps-page ps-page--inner" id="myaccount">
                            ...
                            <div className="divhistorialdevol">
