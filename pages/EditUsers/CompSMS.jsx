...
export default function CompSMS() {
    ...
    switch (tipoInformacion) {
        case "nombres":
            ...
            plantillasms = "Para cambiar tus datos de usuario, debes ingresar el siguiente código: ";
            plantillaemail = "05";
            break;
        case "email":
            titulo = "Editar correo electrónico";
            plantillaws = "registra";
            plantillasms = "Para cambiar tu email, debes ingresar el siguiente código: ";
            plantillaemail = "05";
            break;
        case "DocIdentificacion":
            titulo = "Editar documento de identificación";
            plantillaws = "telefono";
            plantillasms = "Para cambiar tu identificación, debes ingresar el siguiente código: ";
            plantillaemail = "06";
            break;
        case "domicilio":
            titulo = "Editar teléfono de contacto";
            plantillaws = "telefono";
            plantillasms = "Para actualizar dirección, debes ingresar el siguiente código: ";
            plantillaemail = "06";
            break;
        case "teléfono":
            titulo = "Editar teléfono de contacto";
            plantillaws = "telefono";
            plantillasms = "Para actualizar tu teléfono, debes ingresar el siguiente código: ";
            plantillaemail = "05";
            break;
        default:
            titulo = "Editar usuario";
            plantillaws = "registra";
            plantillasms = "Para actualizar tus datos, debes ingresar el siguiente código: ";
            plantillaemail = "01";
    }
    ...
    const redirectToComponent = (nuevoTitulo, item) => {
        ...
        if (item == 1) {
            ...
            if (item == 2) {
                ...
                if (item == 3) {
                    const sendWhatsApp = () => {
                        let parrafo = "Para actualizar tus nombres y apellidos, ingresa este código: "; + nuevoCodigo;
                        let parrafo2 = "Para confirmar, ingresa el siguiente codigo:" + nuevoCodigo;
                                            ...
                                            <Grid
                                                ...
                                                <Box
                                                    ...
                                                    <div
                                                        onClick={() =>
                                                            redirectToComponent(
                                                                "Recibiste un número de 6 dígitos por SMS.", 1
                                                            )
                                                        }
                                                        style={{
                                                            borderRadius: "10px",
                                                ...
                                                <Box
                                                    ...
                                                    <div
                                                        onClick={() =>
                                                            redirectToComponent(
                                                                "Recibiste un número de 6 dígitos por Correo.", 2
                                                            )
                                                        }
                                                        style={{
                                                            borderRadius: "10px",
                                                ...
                                                <Box
                                                    ...
                                                    <div
                                                        onClick={() =>
                                                            redirectToComponent(
                                                                "Recibiste un número de 6 dígitos por Whatsapp.", 3
                                                            )
                                                        }
                                                        style={{
                                                            borderRadius: "10px",
