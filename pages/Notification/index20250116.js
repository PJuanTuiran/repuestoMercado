    ...
    const masDatos = (data) => {
        ...
        const leerDevoluciones = async () => {
            ...
            try {
                const res = await axios({
                    method: "post",
                    url: URL_BD_MR + "271", params
                });

                console.log("Respuesta Devolociones: ", res.data.listardevoluciones);

                if (res.data.type == 1) {
                    console.log("Lista Devoluciones : ", res.data)
                    //setListDevoluciones(res.data.listardevoluciones)
                    setDatosSolicitud(res.data.listardevoluciones[0]);
                    setDataSelectDevol(res.data.listardevoluciones[0]);
        ...
        const leerPrd = async () => {
            ...
            try {
                ...
                router.push({
                    pathname:
                        URL_MK_MR + "MisCompras/msjMensajeRedirigir",
                    query: {
                        uidusuario: JSON.stringify(producto.uidcomprador),
